 ...
 * @url https://gist.github.com/davidwhitman/b83e1744e8435a2c8cba262c1179f1a8
 */
abstract class Preferences(val context: Context) {
    ...
    inner class FloatPrefDelegate(prefKey: String? = null, private val defaultValue: Float) : PrefDelegate<Float>(prefKey) {
    ...
    fun stringSetPref(prefKey: String, defaultValue: Set<String> = HashSet()) = StringSetPrefDelegate(prefKey, defaultValue)
